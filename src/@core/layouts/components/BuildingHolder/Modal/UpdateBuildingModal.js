...
import { PutUpdateBuilding } from '../../../../../core/services/api/building'

const UpdateBuildingModal = ({ show, setShow, selectedItem, refetch }) => {
  ...
  const onSubmit = async (data) => {
    ...
    const response = await PutUpdateBuilding(formData)
    if(!response){

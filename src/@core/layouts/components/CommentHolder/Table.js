...
const Table = () => {
    ...
    const statusOptions = [
      { value: '', label: ' انتخاب کنید...' },
      { value: 'منفور ترین ', label: 'منفور ترین ', number: 2 },
  ...
  const data=[  {text:' سلام جیگر چطوری ', like:'3',dislike:'2',position:'دانشجو', name:'mina' , email:'minaRezaee123@gmail.com'},
                {text:' دوره کاملی بود ', like:'10',dislike:'1',position:'دانشجو', name:'mina' , email:'minaRezaee123@gmail.com'},
                {text:' استاد کم لظفی میکرد جواب نمیداد', like:'2',dislike:'6',position:'دانشجو', name:'mina' , email:'minaRezaee123@gmail.com'},]
  ...
  const columnn=[
    ...
    {
      name: ' تعداد دیس لایک کامنت  ',
      sortable: true,
      minWidth: '172px',
      sortField: 'disLike',
      selector: row => row.dislike,
      // cell: row => renderRole(row)
    },
    {
      name: ' سمت ',
